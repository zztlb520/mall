				...
				>
					<van-pull-refresh v-model="refreshing" @refresh="onRefresh">
						<div v-bind="wrapperProps">
							<div v-for="(item, index) in list" :key="item.index" class="border h-40px">
...
const {list, wrapperProps, containerProps} = useVirtualList<TestList>(allItems.value,{itemHeight: 40,overscan: 10})
