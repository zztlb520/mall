...
export const InitFireworks = (trailsCanvas,mainCanvas)=>{
  // "use strict";
  // console.clear();
  ...
  const trailsStage = stage(trailsCanvas);
  const mainStage = stage(mainCanvas);
  ...
  function init() {
    ...
    // scaleFactor [0.5, 0.62, 0.75, 0.9, 1.0, 1.5, 2.0]
    // initial render
