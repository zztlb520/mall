  ...
  <div :class="[darkMode?'dark':'','logo']">
    ...
    >
      ...
      <g fill="#f1fc02">
        ...
        />
        <path
          d="m5041 5684c-28-32-32-42-29-87 3-46 7-54 37-74 52-35 105-31 147 11 29 29 34 41 34 79 0 39-5 49-35 76-28 25-45 31-79 31-38 0-48-5-75-36zm1987-180c-56-30-80-133-42-175 52-57 125-65 178-18 61 53 58 130-6 184-34 29-87 33-130 9z"
        />
      </g>
      <path
        d="m4900 6529c-256-30-520-180-689-393-160-201-241-427-241-674 0-61 4-113 9-116s76 1 157 9c289 30 698 76 705 80 3 3 12 31 19 64 20 95 67 169 138 218 76 51 147 69 226 54 130-24 211-100 259-243 8-23 4-23 337 15l275 32-2 50c-4 101-83 308-163 425-97 143-269 294-420 370-103 52-247 96-355 109-101 12-147 12-255 0zm2437-445c-271-49-525-207-689-428-58-77-98-145-98-165 0-8 257-141 273-141 4 0 15 17 26 39 28 54 104 129 154 151 62 29 167 27 233-4 64-30 120-86 147-145 26-58 28-185 4-251-9-25-13-48-8-53 9-9 1007-496 1059-516 24-10 35-11 46-2 8 6 30 61 50 120 102 309 50 661-140 948-197 297-527 466-899 462-44 0-115-7-158-15z"
...
#filo {
  ...
  &::after {
    ...
    top: 93%;
    position: absolute;
    border-bottom: 15px solid var(--van-primary-color);
...
.dark.logo{
    ...
    box-shadow: inset 0px 1px 5px rgb(255 255 255 / 10%), inset 0px 2px 20px rgb(255 255 255 / 7%), 40px -15px 15px -5px rgb(0 0 0 / 10%);
    &::after{
        box-shadow: inset 20px 20px 200px #ccc, 5px 0px 1000px #ccc,
        -5px 0px 1000px #ccc, 0px 5px 1000px #ccc;
        opacity: 0;
    }
}
.logo {
  ...
  box-shadow: 0px 0px 10px rgb(255 255 255 / 80%),
    0px 0px 30px rgb(255 255 255 / 80%), 0px 0px 50px rgb(255 255 255 / 60%),
    0px 0px 70px rgb(255 255 255 / 60%),
    -80px -15px 120px 0px rgb(255 255 255 / 40%);
  ...
  &::after {
    ...
    height: 80px;
    border-radius: 50% 50% 50% 50%;
    box-shadow: inset 20px 20px 200px #fff, 5px 0px 1000px #fff,
    -5px 0px 1000px #fff, 0px 5px 1000px #fff;
    opacity: 1;
  ...
  @-ms-keyframes oscillaLampadina {
    from {
      -ms-transform: rotate(3deg) translate(-10.4px, -1px);
    }
    to {
      -ms-transform: rotate(-3deg) translate(10.4px, -1px);
    }
  ...
  @-o-keyframes oscillaLampadina {
    from {
      -o-transform: rotate(3deg) translate(-10.4px, -1px);
    }
    to {
      -o-transform: rotate(-3deg) translate(10.4px, -1px);
    }
